...
/**
 * Created by slayer on 22.09.14.
 */
public class TestLinkIntegration extends AnAction {
    ...
    public void actionPerformed(AnActionEvent anActionEvent) {
        ...
        if ( anActionEvent.getPresentation().getDescription().endsWith("to current class") )
        {
